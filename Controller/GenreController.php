...
use Acme\CatalogFilmsBundle\Entity\Genre;
use Acme\CatalogFilmsBundle\Form\GenreType;
...
class GenreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCatalogFilmsBundle:Genre')->findAll();

        return $this->render('AcmeCatalogFilmsBundle:Genre:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AcmeCatalogFilmsBundle:Genre:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCatalogFilmsBundle:Genre')->find($id);
        ...
        return $this->render('AcmeCatalogFilmsBundle:Genre:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeCatalogFilmsBundle:Genre:edit.html.twig', array(
            'entity'      => $entity,
