...
use Acme\CatalogFilmsBundle\Entity\Actor;
use Acme\CatalogFilmsBundle\Form\ActorType;
...
class ActorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCatalogFilmsBundle:Actor')->findAll();

        return $this->render('AcmeCatalogFilmsBundle:Actor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AcmeCatalogFilmsBundle:Actor:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Actor $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Создать актора'));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCatalogFilmsBundle:Actor')->find($id);
        ...
        return $this->render('AcmeCatalogFilmsBundle:Actor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeCatalogFilmsBundle:Actor:edit.html.twig', array(
            'entity'      => $entity,
